...
<form class="form-horizontal" id="form_bind" method="post">
  ...
  <tr>
    <td colspan="3">银行卡的注册人必须与企业信息中的法人信息相同，绑定后不可更改</td>
    </tr>
  <tr>
    <td width="122">选择银行</td>
    <td width="258"><select class="form-control" name="bank_code">
           <?php foreach($bankinfo as $val=>$key){?>
           		<option value="<?php echo $val;?>" <?php echo set_select('bank_code',$val);?>><?php echo $key;?></option>
           <?php }?>
    </select></td>
    <td width="272">&nbsp;</td>
  </tr>
  <tr>
    <td>银行卡号</td>
    <td><input type="text" name="bank_account_no" class="form-control" placeholder="请输入本人的借记银行卡号" value="<?php echo set_value('bank_account_no');?>"></td>
    <td style="color:#f00"><?php echo form_error('bank_account_no');?></td>
  </tr>
  <tr>
    <td>对公对私</td>
    <td><select name="card_attribute">
    	<option value="B" <?php echo set_select('card_attribute','B');?>>对公</option>
        <option value="C" <?php echo set_select('card_attribute','C');?>>对私</option>
    </select></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>银行预留手机</td>
    <td><input type="text" name="phone_no" class="form-control" placeholder="请输入银行预留手机号码" value="<?php echo set_value('phone_no');?>"></td>
    <td style="color:#f00"><?php echo form_error('phone_no');?></td>
  </tr>
  <tr>
    <td>银行卡所在省</td>
    <td><select class="form-control prov" name="prov"></select></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>银行卡所在市</td>
    <td><select class="form-control city" name="city"></select></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>支行名称</td>
    <td><input type="text" name="bank_branch" class="form-control" value="<?php echo set_value('bank_branch');?>"></td>
    <td style="color:#f00"><?php echo form_error('bank_branch');?></td>
  </tr>
  <tr>
