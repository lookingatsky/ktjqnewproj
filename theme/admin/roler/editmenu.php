...
<table class="table table-bordered table-hover m10">
    <tr>
        ...
        <td>
            <select name="pid">
            	<option value="0" <?php echo set_select('pid',0,$row['pid']==0?true:false); ?>>顶级菜单</option>
    ...
    <tr>
      ...
      <td>
      <input type="radio" name="show" value="0" <?php echo set_radio('show',0,$row['show']==0?true:false); ?>/>显示
      <input type="radio" name="show" value="1" <?php echo set_radio('show',1,$row['show']==1?true:false); ?>/>不显示
      </td>
    </tr>
    <tr>
        <td class="tableleft">控制器/方法</td>
        <td><input type="text" name="uri" value="<?php echo set_value('uri',$row['uri']);?>"/><?php echo form_error('uri');?></td>
    </tr>
     <tr>
