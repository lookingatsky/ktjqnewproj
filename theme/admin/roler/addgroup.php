...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td>
			...
			?>
        	<dl id="roler">
            	<dt><input type="checkbox" value="<?php echo $key['id'];?>" name="roler[]" <?php echo set_checkbox('roler[]',$key['id']);?>/> <?php echo $key['name'];?></dt>
                <?php foreach($menulist as $key_s){
					if($key_s['pid'] == $key['id']){
				?>
                <dd><input type="checkbox" value="<?php echo $key_s['id'];?>" name="roler[]" <?php echo set_checkbox('roler[]',$key_s['id']);?>/> <?php echo $key_s['name'];?></dd>
                <?php } }?>
            </dl>
            <?php } }?>
