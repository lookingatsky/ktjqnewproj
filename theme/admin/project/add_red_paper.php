...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td><input type="text" name="monkey" value="<?php echo set_value('monkey');?>"/><?php echo form_error('monkey');?></td>
    </tr>
    <tr>
        <td class="tableleft" width="15%">红包最小使用金额</td>
        <td><input type="text" name="min_monkey" value="<?php echo set_value('min_monkey');?>"/><?php echo form_error('min_monkey');?></td>
    </tr>
    <tr>
