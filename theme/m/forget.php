...
<div class="container" style="padding-bottom: 20px;">
    <div class="row" style="margin-top: 10px;">
        ...
        <form class="col-xs-12" id="regesiter_form" method="post">
            ...
            <div class="form-group" style="margin-top:20px;">
                <input type="text" class="form-control input-lg" name="mobile" id="mobile" placeholder="请输入您的手机号" value="<?php echo set_value('mobile');?>">
            ...
            <div class="form-group">
                <input type="password" class="form-control input-lg" placeholder="请输入您的新密码" name="password" id="password" value="<?php echo set_value('password');?>">
    ...
    <div class="row" style="margin-top: 10px;">
        ...
        <div class="col-xs-6 haveAccount" style="text-align: right;">
            <a href="<?php echo site_url('m/welcome/login');?>">想起账号，<span style="text-decoration:underline;">立即登录</span></a>
        </div>
    </div>
</div>
<style>
