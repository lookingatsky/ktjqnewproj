...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
           ...
           <?php if(isset($error)){?>
            ...
            <?php }?>
            <div class="alert alert-danger" role="alert" style="margin-top:10px">应建设银行要求，如需绑定建行银行卡，需前往银行网点开通“网上银行高级版”，并成功登陆一次，方可完成绑卡和使用快捷支付。（详情进入建行官网查看公告）</div>
            <form class="form-horizontal" id="form_bind" method="post">
            <p></p>
            <div class="form-group">
   		 			<label class="control-label col-sm-2">持卡人信息</label>
                    <div class="col-sm-5">
                   		<?php $userinfo = userinfo();?>
                        <p>持卡人姓名：<?php echo $userinfo['name'];?></p>
                       	<p>持卡人身份证:<?php echo $userinfo['idcard'];?></p>
            	...
            	<div class="form-group">
    				...
    				<div class="col-sm-5">
                        <select class="form-control" name="bank_code" style="height:46px; line-height:46px">
                ...
                <div class="form-group <?php if(form_error('verify_mode') != ""){echo "has-error"; }?>">
                    ...
                    <div class="col-sm-5">
                    <select name="verify_mode" class="form-control" style="height:46px; line-height:46px">
                ...
                <div class="form-group has-feedback <?php if(form_error('bank_account_no') != ""){echo "has-error"; }?>">
   		 			<label class="control-label col-sm-2">银行卡号</label>
                    <div class="col-sm-5">
    					<input type="text" name="bank_account_no" class="form-control" placeholder="请输入本人的借记银行卡号" value="<?php echo set_value('bank_account_no');?>" style="height:46px; line-height:46px">
                        <span class="glyphicon glyphicon-credit-card form-control-feedback" style="height:46px; line-height:46px"></span>
                    </div>
 				</div>
                <div class="form-group has-feedback <?php if(form_error('phone_no') != ""){echo "has-error"; }?>">
   		 			<label class="control-label col-sm-2">预留手机号</label>
                    <div class="col-sm-5">
    					<input type="text" name="phone_no" class="form-control" placeholder="请输入银行预留手机号码" value="<?php echo set_value('phone_no');?>" style="height:46px; line-height:46px">
                        <span class="glyphicon glyphicon-phone form-control-feedback" style="height:46px; line-height:46px"></span>
                    </div>
 				</div>
                <div class="form-group">
   		 			<label class="control-label col-sm-2">开户行所在省</label>
                    <div class="col-sm-3">
    					<select class="form-control prov" name="prov" style="height:46px; line-height:46px"></select>
                    </div>
 				</div>
                <div class="form-group">
   		 			<label class="control-label col-sm-2">开户行所在市</label>
                    <div class="col-sm-3">
    					<select class="form-control city" name="city" style="height:46px; line-height:46px"></select>
                    </div>
 				</div>
                <div class="form-group has-feedback <?php if(form_error('bank_branch') != ""){echo "has-error"; }?>">
   		 			<label class="control-label col-sm-2">支行名称</label>
                    <div class="col-sm-5">
    					<input type="text" name="bank_branch" class="form-control" value="<?php echo set_value('bank_branch');?>" style="height:46px; line-height:46px"><span class="glyphicon glyphicon-home form-control-feedback" style="height:46px; line-height:46px"></span> 
                    </div>
 				</div>
                 <div class="form-group">
   		 			<label class="control-label col-sm-2"></label>
                    <div class="col-sm-5">
    					 <button type="button" class="btn btn-success btn-block btn-lg" id="submit_add">提交</button>
                    </div>
 				</div>
            </form>
