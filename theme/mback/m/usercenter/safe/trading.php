...
<div class="container" style="margin-top: 0px;">
    <h3 class="page-header">交易密码</h3>
</div>
<div class="container" style="padding-bottom: 20px;">
    <div class="row" style="margin-top: 10px;">
        <form class="col-xs-12" id="regesiter_form" method="post">
            <div class="form-group">
                <label for="message-text">交易密码：</label>
                <input type="password" class="form-control" name="trading" id="trading" placeholder="请输入您的交易密码" value="<?php echo set_value('trading');?>">
                <?php echo form_error('trading');?>
            </div>
            <div class="form-group">
                <label for="recipient-name">确认密码：</label>
                <input type="password" class="form-control" placeholder="请确认您的交易密码" name="match_trading" id="match_trading" value="<?php echo set_value('match_trading');?>">
                <?php echo form_error('match_trading');?>
            </div>
            <div class="form-group">
                <label for="recipient-name">验证码：</label>
                <div class="row">
                 <div class="col-xs-7">
