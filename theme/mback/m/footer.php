...
<div style="height:58px; overflow:hidden; width:100%"></div>
<div class="iphone">
	<div><a href="<?php echo site_url('m');?>"><img src="<?php echo base_url();?>style/img/phoneimg1.png" width="19"><br>首页</a></div>
    <div><a href="<?php echo site_url('m/usercenter');?>"><img src="<?php echo base_url();?>style/img/phoneimg2.png" width="19"><br>我的</a></div>
    <div><a href="<?php echo site_url('m/product/bulk_standard_list');?>"><img src="<?php echo base_url();?>style/img/phoneimg3.png" width="17"><br>投资</a></div>
