        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <form class="form-horizontal" id="form_bind" method="post">
                ...
                <div class="form-group <?php if(form_error('verify_mode') != ""){echo "has-error"; }?>">
                    ...
                    <div class="col-sm-5">
    					<input type="radio" name="verify_mode" value="1" <?php echo set_radio('verify_mode',1,true);?>>支付提现卡
                        <input type="radio" name="verify_mode" value="2" <?php echo set_radio('verify_mode',2);?>>提现卡
                    </div>
 				</div>
            ...
            <div class="alert alert-danger" role="alert">应建设银行要求，如需绑定建行银行卡，需前往银行网点开通“网上银行高级版”，并成功登陆一次，方可完成绑卡和使用快捷支付。（建行官网通告：<a href="https://ibsbjstar.ccb.com.cn/app/V5/CN/STY1/FB30101_notice.jsp" target="_blank">https://ibsbjstar.ccb.com.cn/app/V5/CN/STY1/FB30101_notice.jsp</a>）</div>
            <?php if(isset($error)){?>
