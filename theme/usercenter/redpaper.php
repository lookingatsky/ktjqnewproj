							...
							<div class="col-md-8 col-xs-8" style="margin-top:50px;">
								<div class="row">
									...
									<div class="col-md-10 col-xs-10">
										<input type="text" readonly="readonly" class="form-control inviteLink" id="name" value="<?php echo $inviteLink;?>">
									</div>
									<div class="col-md-1 col-xs-1"></div>
								</div>
								<div class="row">
...
<script>
   ...
   <script type="text/javascript" charset="utf-8" src="https://static.bshare.cn/b/buttonLite.js#style=-1&amp;uuid=6e788e5d-4d31-4d84-913d-c1f6aeaefffc&amp;pophcol=2&amp;lang=zh"></script>
