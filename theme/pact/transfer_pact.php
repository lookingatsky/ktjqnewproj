...
<div class="container" style="width: 800px; margin:0 auto">
    ...
    <p>3、在本协议约定的借款期限届满之前，乙方可提前还款，但提前还款应当向甲方提出申请，提前还款的利息按本合同第六条提前还款条例所示 。乙方不得将本协议项下的任何权利义务转让给任何其他方。 </p>
    <p>4、借款方需提供相应证明文件含且不仅局限以下文件：<br>
        营业执照,税务登记证,和企业代码证<br>购销合同</p>
    <h4>丙方权利和义务 </h4>
    <p>1、丙方提供保证担保。如乙方到期不能偿还本合同约定的本金和利息，甲方可向丙方追偿。></p>
    <p>2、甲乙双方如变更借款事项，包括但不限于借款金额、利息、借款期限和用途，债权转移，应及时通知丙方争得丙方书面同意，否则丙方不再承担本合同下的担保义务。</p>
    <p>3、保证方需提供相关证明文件含且不仅局限于以下文件：<br>资产证明（土地证，林权证）<br>保证合同书
        营业执照,税务登记证,和企业代码证<br>
    </p>

    <h4>丁方权利和义务 </h4>
    <p>1、丁方应当遵循本协议，充分协助甲乙双方的借款事宜。</p>
    <p>2、丁方有义务对甲乙双方的信息、信誉进行审核，并对借款双方相关信息，按照国家相关法律向两方信息披露。</p>
    <p>3、丁方应依据其与支付机构北京新浪支付科技有限公司签订的《互联网金融资金管理服务协议》，协助和保证甲方提供的借款按时支付到本合同项下的第三方平台新浪支付监管帐户，并保证该款项由第三方平台支付给乙方。</p>
    <p>4、丁方有义务对甲乙双方相关固有资产，担保情况，运营状况等相关信息进行审核评估，对借款方担保财产进行评估。</p>
    <p>快投机器资产评估报告</p>
