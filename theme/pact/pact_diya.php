...
<div class="container" style="width: 800px; margin:0 auto" id="print">
    ...
    <table border="1" cellspacing="0" cellpadding="0" width="100%" >
        ...
        <tr>
            <td>借款总本金</td>
            <td><?php echo $info[1]['monkey'];?>元(<?php echo ParseNumber(sprintf("%d", $info[1]['monkey']));?>)</td>
        </tr>
        <tr>
            <td>年化利率</td>
    ...
    <h3>第二条 借款流程</h3>
    <p>1、本协议成立：甲方按照丙方快投机器平台的规则，通过在平台上对乙方通过平台发布的借款需求点击“购买”确认时，本协议立即成立。</p>
    <p>2、出借资金冻结：甲方点击“购买”即视为其已经向丙方发出不可撤销的授权指令，授权丙方委托第三方支付机构或资金监管银行等合作机构，在监管账户中冻结甲方出借金额的资金。上述冻结在本协议生效时或本协议确定失效时解除。</p>
    <p>3、本协议生效：本协议在乙方发布的借款需求全部得到满足，即乙方借款需求所对应的资金已经全部到达乙方资金管理账户时生效。 </p>
    <p>4、出借资金划转：本协议生效时，乙方即不可撤销地授权丙方委托相应的第三方支付机构或资金监管银行，将每期借款本金数额的资金划转至乙方的互联网金融资金管理账户，划转完毕即视为借款发放成功，借款利息及相关费用开始计算。</p>
    <p>5、本协议各方均通过快投机器的合作方新浪支付平台进行借款和还款的支付。甲方同意向乙方出借相关款项时，委托快投机器通过新浪支付平台将借款直接划转到乙方账户；乙方向甲方还款时，委托快投机器通过新浪支付平台将还款直接划转到甲方帐户；</p>
    <p>6、本协议中的每个出借人与借款人之间的借贷法律关系均是相互独立的。</p>
    <p>7、丙方作为平台方仅为甲乙双方的借款和还款提供居间服务及相关中介服务，不是借贷关系的主体。</p>
	
	<h3>第三条 借款资金来源保证</h3>
	<p>甲方保证其所用于出借的资金来源合法，甲方是该资金的合法所有人，如果第三方对资金归属、合法性问题提出异议，由甲方自行解决。如甲方未能解决导致甲方不能获得本协议下借款利息的，甲方无权向乙丙追偿。</p>
	
	<h3>第四条 收费及税费</h3>
	<p>1、丙方有权就为本协议借款所提供的服务向乙方收取手续费和服务费、催收费等费用，上述费用的收取方式由乙、丙双方另行约定。</p>
	<p>2、甲方应自行负担并主动缴纳因利息收益带来的可能的税费。</p>
	
	<h3>第五条 偿还方式</h3>
	<p>1、乙方必须按照本协议的约定按时、足额偿还对甲方的借款本金和利息。乙方在每月付息日当日（不得迟于24:00）或之前支付乙方当期应支付的本息。</p>
	<p>2、乙方指定其在新浪支付平台的互联网金融资金管理账户为本协议的还款收款账户，每期本息一经划转至乙方在新浪支付平台的互联网金融资金管理账户后，即视为乙方已经履行本协议项下对甲方的相应还款义务。收到上述本息后，丙方根据与甲方之间的约定通过第三方支付平台向甲方统一划转该等资金。</p>
	...
	<p>2、甲方根据本协议转让借款债权时，乙方不可撤销地授权丙方代为接收该等转让通知；债权受让人依法承接甲方在本协议项下的权利和义务。债权转让后，乙方需对债权受让人在剩余借款期限继续履行本协议下其对甲方的还款义务，丙方在原保证担保的范围内继续承担本协议项下的代偿责任。</p>
	...
	<p>2、甲方应按合同约定的借款日将足额的借款金支付到丙方指定第三方资金支付机构/监管平台。甲方享有其所出借款项所带来的利息收益。</p>
	<p>3、在本协议约定的借款期限届满之前，甲方不得要求乙方提前还款。甲方可以根据自己的意愿进行本协议下其对乙方债权的转让，并书面通知乙方、丙方和丙方，并在平台系统做变更登记。在甲方的债权转让后，乙方需对债权受让人继续履行本协议下其对甲方的还款义务。</p>
	...
	<h4>丙方权利和义务</h4>
	<p>1、丙方应当遵循本协议，为甲乙双方的借款事宜提供网络平台服务。</p>
	<p>2、丙方有义务对甲乙双方的信息、信誉进行审核，并对借款双方相关信息，按照国家相关法律向两方信息披露。</p>
	<p>3、丙方应充分保守甲乙丙三方的个人和企业信息，不得随意使用或对外披露相关信息。</p>
	<p>4、丙方应依据其与支付机构北京新浪支付科技有限公司签订的《互联网金融资金账户管理服务协议》，协助和保证甲方提供的借款按时支付到本合同项下的第三方平台新浪支付监管帐户，并保证该款项由第三方平台支付给乙方。</p>
	<p>5、丙方有义务对甲乙双方相关身份、资质信息、固有资产、担保情况，运营状况等相关信息进行审核评估，对借款方担保财产进行评估。</p>
